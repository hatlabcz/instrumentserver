...
class StationServer(QtCore.QObject):
        ...
        with ThreadPoolExecutor() as pool:
            while self.serverRunning or not self._response_queue.empty():
                try:
                    ...
                    while True:
                        try:
                            identity, response_to_client, response_log = self._response_queue.get_nowait()
                        except queue.Empty:
                            break
    ...
    def _handleRouterMessage(self, identity, message):
        ...
        # We assume this is a valid instruction set now.
            ...
            response_to_client.request_id = instruction.request_id
        ...
        self._response_queue.put((identity, response_to_client, response_log))
